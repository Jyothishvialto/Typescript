...
{
    reconstruct(s: string): string 
    {
        const count: number[] = new Array(26).fill(0); // To count each character from 'a' to 'z'
        ...
        const digitCount: number[] = new Array(10).fill(0); // To count each digit 0-9
        ...
        let result: string = ''; // To store the final digit string in ascending order
...
// Example usage:
const s1:string = "fviefuro"; // Input string
